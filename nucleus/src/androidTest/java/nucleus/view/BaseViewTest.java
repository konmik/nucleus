...
public abstract class BaseViewTest<ActivityType extends Activity> extends BaseActivityTest<ActivityType> {
    ...
    public void setUp() throws Exception {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                when(mockPresenterManager.provide(any(Presenter.class), any(Bundle.class))).thenReturn(mockPresenter);
    ...
    public void testInit() {
        ...
        verify(mockPresenterManager, times(1)).provide(any(), isNull(Bundle.class));
    ...
    public void testDestroy() throws Throwable {
        ...
        getInstrumentation().waitForIdle(new Runnable() {
            @Override
            public void run() {
                verify(mockPresenterManager, times(1)).destroy(any(Presenter.class));
            }
        });
    }
    ...
    public void testRestart() throws Throwable {
        ...
        runTestOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                verify(mockPresenterManager, times(1)).provide(notNull(), argThat(new ArgumentMatcher<Bundle>() {
                    @Override
